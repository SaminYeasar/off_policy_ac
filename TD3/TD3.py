...
class TD3(object):
    ...
    def train(self, logger, args, env, replay_buffer, iterations, lmbda=0, batch_size=200, discount=0.99, tau=0.005, policy_noise=0.2, noise_clip=0.5, policy_freq=2):
        ...
        for it in range(iterations):
            ...
            noise = torch.FloatTensor(action).data.normal_(0, policy_noise).to(device)
            ...
            target_Q1, target_Q2 = self.critic_target(next_state, next_action) # next action comes from actor-target
